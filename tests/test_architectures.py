...
class TestArchitectureInstantiation:
    ...
    def test_standard_architecture_loads(self, architecture, device, num_classes_small, base_config_template):
    ...
    def test_inception_architecture_loads(self, architecture, device, num_classes_small, base_config_template):
...
class TestFinalLayerReplacement:
    ...
    @pytest.mark.parametrize('architecture', [
        'resnet18', 'vgg16', 'efficientnet_b0', 'mobilenet_v2',
        'densenet121', 'convnext_tiny', 'swin_t', 'vit_b_16'
    ])
...
class TestForwardPass:
    ...
    @pytest.mark.parametrize('architecture', ALL_STANDARD_ARCHITECTURES)
    def test_standard_forward_pass(self, architecture, device, num_classes_small,
                                   base_config_template, sample_input_224, batch_size):
        ...
        # Check output shape
        assert output.shape == (batch_size, num_classes_small), \
    ...
    @pytest.mark.parametrize('architecture', INCEPTION_FAMILY)
    def test_inception_forward_pass(self, architecture, device, num_classes_small,
                                   base_config_template, sample_input_299, batch_size):
...
class TestPretrainedWeights:
    ...
    def test_pretrained_loading(self, architecture, device, num_classes_small, base_config_template):
...
class TestBatchSizes:
    ...
    def test_various_batch_sizes(self, architecture, batch_size, device,
                                num_classes_small, base_config_template):
...
class TestErrorHandling:
    ...
    def test_invalid_architecture_raises_error(self, device, num_classes_small, base_config_template):
