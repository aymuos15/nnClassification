...
from ml_src.core.data.datasets import get_datasets, get_transforms
from ml_src.core.loader import create_dataloaders
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, config: Dict, client_id: int, run_dir: str):
        ...
        self.dataloaders, self.dataset_sizes = create_dataloaders(
