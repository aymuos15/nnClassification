...
# Quick test
python train.py --fold 0 --num_epochs 3 --batch_size 8

# High-performance training
python train.py --fold 0 --batch_size 64 --num_workers 8 --num_epochs 100
...
# Inference
python inference.py --run_dir runs/base_fold_0 --checkpoint best.pt
